package spacerocket.com.infounebapp.fragment;
 ...
 */
public class InfoSaude extends Fragment {
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_infosaude, container, false);
        tool = (Toolbar) v.findViewById(R.id.toolbar);
        initCollapsingToolbar();
        FirebaseConfig ref = new FirebaseConfig();
        ref.addDatabaseChild("InfoSaude/Informacoes");
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle("InfoSaúde");
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle(" ");
                    isShow = false;
